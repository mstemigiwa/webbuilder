 ...
 */
	Configure::write('Security.salt', 'IAHSasKLA0a9u8ASjsa89nJNmb98Yc89Cuc9c0TG');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '39837439403489378201834748404');
...
/*
 * Voguepay configuration details
 */
 Configure::write('VoguePay.merchant_id','demo');
 Configure::write('VoguePay.store_id','898');
 Configure::write('VoguePay.developer_id','560308e921cd3');
 Configure::write('VoguePay.post_url','https://voguepay.com/pay/');
